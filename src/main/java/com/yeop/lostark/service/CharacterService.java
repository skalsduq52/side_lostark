...
public class CharacterService {
    ...
    private ArmoryProfile profiles;

    public ArmoryProfile getUser(String characterName) throws IOException, InterruptedException {
        ...
        if(response.statusCode() == 200) {
            ...
            profiles = objectMapper.readValue(jsonResponse, ArmoryProfile.class);
